...
Ett skepp kontrolleras av den spelare som ensam har kämpar ombord. Om
...
<!-- visas så är kastet avklarat och resultatet kan tydas. -->
...
2. Aktivera ett eller flera skepp (beroende på spelat kort).
...
utföra en handling per tur. Det kan till exempel vara att ro, skjuta
pilbåge, eller äntra ett fiendeskepp. Förflyttning och närstrid är
tätt sammankopplade och räknas därför som en handling i det här
avseendet.
...
bara utföras om inga fiendekämpar finns ombord på det aktiverade
skeppet.
...
- Bågskyttar når 40 cm (mätt från skepp till skepp).
...
åtta kämpar. Att starta en närstrid på det aktiverade skeppet (dvs en
förflyttning med längd 0) går även det bara att utföra en gång per
...
intilliggande skepp, men inte om det skeppet också innehåller
fiendekämpar (en flykt kan aldrig leda till anfall / strid). I så fall
måste man först försöka besegra fienderna ombord med en grupp kämpar
innan en annan grupp gör anfallet in på det intilliggande skeppet.

##### Närstrid
En förflyttning som sker ombord eller slutar på ett skepp som
innehåller fiendekämpar, leder till närstrid. Följande kämpar deltar i
striden:

- De kämpar som valts ut till att flytta från det aktiverade skeppet
  (1-8 st).
- Valfritt antal vänliga kämpar på skeppet som de flyttar till, om de inte
  redan deltagit i strid den här turen (vid en tidigare
  aktivering). Den totala gruppen kämpar från anfallarens lag som
  deltar i striden får ej överstiga 8.
- Fiendekämpar ombord på skeppet dit förflyttningen sker
...
Endast de kämpar som räknas in i striden kan ta skada.
...
bestämmer vilken kämpe som faller, med begränsningen att kämparna
måste väljas i den ordning som listades under *avståndsstrid*
tidigare.
...
största antalet kämpar som teoretiskt sett kan flyttas är alla de som
...
### Vinstpoäng
- Varje fiendeskepp man kontrollerar: 10 poäng för vanliga skepp, 15 poäng
  för kungaskepp
- Varje stupad fiendeledare: 20 poäng
